...
namespace SnakeGame.Players.Jardik
{
    public class Jardik : IPlayerBehaviour2
    {
        ...
        public void Init(int identificator, int max, int x, int y, SnakeGame.Interface.Direction direction)
        {
            _max = max;
        ...
        public SnakeGame.Interface.Move GetNextMove(int[,] gameSurrond)
        {
            _round++;
            ...
            if (nextMove!=null)
            {
                ...
                return (SnakeGame.Interface.Move)nextMove.Move;                
            }
            else
            {
                return (SnakeGame.Interface.Move)Move.Straight;
            }
        }
